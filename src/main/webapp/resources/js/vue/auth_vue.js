...
auth_vue ={
	...
	join_body : ()=>{
		...
		'          </div>'+
		'          <div class="col-md-6 mb-3">'+
		'            <label for="password">이메일 중복체크</label>'+
		...
		'          <input type="text" class="form-control" id="cpwd" placeholder="15자이내">'+
		'        </div>'+
		'		<div class="mb-3">'+
...
//		'            </div>'+
	...
	login_body : x=>{
		...
		'  <input type="text" id="cemail" class="form-control" placeholder="Email address" required="" autofocus="">'+
